...
class glandular_evaluator:
    ...
    def __init__(
        ...
        nmsthre,
        num_classes,
        gt_csv_path='datasets/glandular1536_20211217/8-1-1/val_glandular1&2.csv',
    ...
    def evaluate(
        ...
        # aps = []
        # for i in range(1, 10):
        recall, precision, ap = custom_voc_eval(self.gt_csv_path, self.loc_csv_path, ovthresh=0.5, num_class=self.num_classes)
            # aps += [ap]
        aps = [ap]
...
class Exp(MyExp):
    def __init__(self):
        ...
        # ------------
        # self.model = self.get_model(postproc=False)
    ...
    def get_model(self, postproc=False):
        if getattr(self, "model", None) is None:
            self.model = build_model(self.parser, num_classes=self.num_classes, input_size=list(self.input_size))
            self.model.set_postproc(postproc)
        return self.model
    ...
    def get_data_loader(self, batch_size, is_distributed, no_aug=False, cache_img=False, data_type=None):
        ...
        dataset = get_dataset("datasets/glandular1536_20211217/8-1-1/train_glandular1&2.csv",
                              datatype="train",
    ...
    def get_evaluator(self, batch_size, is_distributed, testdev=False, legacy=False):
        ...
        if testdev:
            gt_csv_path='datasets/glandular1536_20211217/8-1-1/test_glandular1&2_w_ood.csv'
        else:
            gt_csv_path='datasets/glandular1536_20211217/8-1-1/val_glandular1&2.csv'
